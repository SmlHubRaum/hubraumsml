...
c = ENSClient("devtest.sml-evo-dev")
...
#    pdb.set_trace()
	...
	while True:
	    ...
	    s.auth =('admin','Sml1Orchestrator')
            rsp = s.request(api = '/LTECamOrchestrator/rest/statistics/cameras', method = 'GET', header = JSON_HEADER)
	    print rsp.text
